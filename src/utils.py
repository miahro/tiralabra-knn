...
def list_of_indices(distance_array):
    ...
    ind = np.unravel_index(np.argsort(distance_array, axis=None), distance_array.shape)
    ...
    return lst[1:] #lst[0] on aina (0,0). Tätä ei tarvita, ja aiheuttaisi turhaa laskentaa
