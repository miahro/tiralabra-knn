...
class TestMnistdata(unittest.TestCase):
    ...
    def test_X_train_matrix(self):
        ...
        self.assertEqual(
            len(self.mndata.X_train_matrix(start=0, end=5000)), 5000)
        self.assertEqual(
            len(self.mndata.X_train_matrix(start=0, end=100)[0]), 28)
        self.assertEqual(
            len(self.mndata.X_train_matrix(start=0, end=100)[0][0]), 28)
    ...
    def test_X_test_matrix(self):
        ...
        self.assertEqual(
            len(self.mndata.X_test_matrix(start=0, end=5000)), 5000)
        for i in range(10):
            self.assertEqual(
                len(self.mndata.X_test_matrix(start=0, end=100)[i]), 28)
            self.assertEqual(
                len(self.mndata.X_test_matrix(start=0, end=100)[i][0]), 28)
    ...
    def test_Y_train_labels(self):
        ...
        self.assertEqual(
            len(self.mndata.Y_train_labels(start=0, end=5000)), 5000)
    ...
    def test_Y_test_labels(self):
        ...
        self.assertEqual(
            len(self.mndata.Y_test_labels(start=0, end=5000)), 5000)
